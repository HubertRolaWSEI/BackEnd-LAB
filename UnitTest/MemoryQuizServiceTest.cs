...
public class MemoryQuizServiceTest
{
    ...
    public MemoryQuizServiceTest()
    {
        ...
        _aservice.AddQuizItem(points: 1, correctAnswer: "A", incorrectAnswers: new List<string>() { "B", "C", "D" },
            question: "Pierwsza litera alfabetu?");
        _aservice.AddQuizItem(points: 1, correctAnswer: "B", incorrectAnswers: new List<string>() { "A", "C", "E" },
            question: "Druga litera alfabetu?");
        _aservice.AddQuizItem(points: 1, correctAnswer: "C", incorrectAnswers: new List<string>() { "A", "B", "F" },
    ...
    {
        _aservice.AddQuizItem(points: 2, correctAnswer: "A", incorrectAnswers: new List<string>() { "B", "C", "D" },
            question: "Pierwsza litera alfabetu?");
